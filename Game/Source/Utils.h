...
public:
	...
	// This bariant of the "CheckCollision" type function does not accept as collision when 2 bodies are barely toaching. It detects collision when the rectangle generated by the intersection has at lease width 1 and height 1.
	bool CheckCollisionLimits(SDL_Rect r1, SDL_Rect r2) const
	{
		if ((r1.x >= r2.x + r2.w) || (r1.x + r1.w <= r2.x) || (r1.y >= r2.y + r2.h) || (r1.y + r1.h <= r2.y))
		{
			return false;
